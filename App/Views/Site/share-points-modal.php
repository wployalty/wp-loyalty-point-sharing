<!-- Share Points Button -->
<?php $wlps_theme_color = \Wlr\App\Helpers\Settings::get( 'theme_color', '#4F47EB' ); ?>
<a href="#" id="wlps-open-share-modal" class="wlps-open-share"
   style="text-decoration: none; font-weight: bold; color: <?php echo esc_attr( $wlps_theme_color ); ?>; margin-left: 10px"
...
<div id="wlps-share-points-modal" class="wlps-modal" style="display:none;">
    <div class="wlps-modal-content">
        ...
        <h3 style="font-family:'Source sans pro';font-weight: bold"><?php esc_html_e( 'Share Loyalty Points', 'wp-loyalty-point-sharing' ); ?></h3>
